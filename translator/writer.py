...
class Writer:
    ...
    def save_translated_book(self, book: Book, ouput_file_format: str):
        ...
        if ouput_file_format.lower() == "pdf":
            ...
            LOG.error(f"Unsupported file format: {ouput_file_format}")
            return ""
    ...
    def _save_translated_book_pdf(self, book: Book, output_file_path: str = None):
        ...
        LOG.info(f"Exporting: {output_file_path}")
                ...
                if content.status:
                    if content.content_type == ContentType.TEXT:
                        ...
                        table_style = TableStyle([
                            ...
                            ('FONTNAME', (0, 0), (-1, 0), 'SimSun'),   # Change the font of the table header to "SimSun"
                            ('FONTSIZE', (0, 0), (-1, 0), 14),
                            ('BOTTOMPADDING', (0, 0), (-1, 0), 12),
                            ('BACKGROUND', (0, 1), (-1, -1), colors.beige),
                            ('FONTNAME', (0, 1), (-1, -1), 'SimSun'),  # Change the font of the table content to "SimSun"
